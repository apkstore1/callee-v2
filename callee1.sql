...
INSERT INTO `users` (`id`, `username`, `password`, `role`, `credits`, `admin_id`, `status`, `availability_status`, `allow_auto_dial`, `allow_call`, `allow_message`, `sip_extension`, `sip_password`) VALUES
(3, 'sadmin', '12345', 'superadmin', 0.00, NULL, 'active', 'online', 0, 1, 1, '', ''),
(7, 'admin', '12345', 'admin', 100.00, NULL, 'active', 'online', 0, 1, 0, NULL, NULL),
(8, 'agent', '12345', 'agent', 0.00, 7, 'active', 'online', 0, 1, 1, '100', '100'),
(9, 'agent1', '12345', 'agent', 0.00, NULL, 'active', 'online', 0, 1, 1, NULL, NULL);
